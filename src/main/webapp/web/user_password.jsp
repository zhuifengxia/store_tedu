...
<body>
	...
	<div id="nav_order">
		<ul>
			<li><a href="../main/index.do">首页<span>&gt;</span>个人中心
			</a></li>
		</ul>
	</div>
	<!--我的订单内容区域 #container-->
	<div id="container" class="clearfix">
		...
		<div class="rightsidebar_box rt">
			<div class="rs_header">
				<span><a href="profile.do">我的信息</a></span> <span
					class="rs_header_active"><a href="password.do">安全管理</a></span>
			</div>
			...
			<div class="rs_content">
				...
				<div class="new_password">
					<span class="word">输入旧密码：</span> <input type="password"
						id="old_password" maxlength="32" /> <span class="change_hint"
						id="old_password_hint"></span>
				</div>
				<div class="new_password">
					<span class="word">输入新密码：</span> <input type="password"
						id="new_password" maxlength="32" /> <span class="change_hint"
						id="new_password_hint"></span>
				</div>
				<div class="confirm_password">
					<span class="word">确认新密码：</span> <input type="password"
						id="confirm_password" maxlength="32" /> <span class="confirm_hint"
						id="confirm_password_hint"></span>
				</div>
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#leftsidebar_box .count_managment dt").find('img').attr("src",
		...
		function changePassword() {
			...
			//基础判断
			if (checkPasswordLength(pwd1) && checkPasswordLength(pwd2)
					&& checkPasswordLength(pwd3) && checkPasswordEquals()) {
				$.ajax({
