                ...
                <div class="imfor">
                    ...
                    <div class="pudc">
                        <div class="pudc_information" id="pudcId3">
                            <img width=100 height=80 src="${ pageContext.request.contextPath}${cart.goods.image }" class="lf"/>
                            <input type="hidden" name="" value="">
                        <span class="des lf">
                           ${cart.goods.title }
                              <input type="hidden" name="" value="">
                        </span>
                            <p class="col lf"><span>分类：</span><span class="color_des">${cart.goods.itemType } <input type="hidden" name="" value=""></span></p>
                        </div>
                    </div>
                    <div class="pices">
                        <p class="pices_des">达内专享价</p>
                        <p class="pices_information"><b>￥</b><span>${cart.goods.price }.00  <input type="hidden" name="" value=""></span></p>
                    </div>
                    <div class="num"><span class="reduc">&nbsp;-&nbsp;</span><input type="text" value="${cart.goodsCount }" ><span class="add">&nbsp;+&nbsp;</span></div>
                    <div class="totle">
                        <span>￥</span>
                        <span class="totle_information">${cart.goods.price*cart.goodsCount }.00</span>
                    </div>
                    <div class="del">
                        <!-- <div>
