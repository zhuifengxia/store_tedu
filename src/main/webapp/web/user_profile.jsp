			...
			<div class="rs_content">
				<form id="user-profile">
					...
					<div class="rs_content_username">
						...
						<input class="ed_username" id="username" name="username"
							value="${user.username}"
							style="display: none; height: 30px; border: 1px solid #dedede" />
					...
					<div class="rs_content_sex">
						<span class="same">性别：</span> <input type="radio" name="gender"
							...
							<c:if test="${user.gender==0 }">checked="checked"</c:if> />女 <span
							class="man selected" style="display: none;"> <img
							src="../images/personage/select.png" alt="" />男
						</span> <span class="women" style="display: none;"> <img
					...
					<div class="rs_content_mail">
						<span class="same">绑定邮箱：</span> <input class="ed_email" id="email"
							name="email" value="${user.email}"
							style="display: none; height: 30px; border: 1px solid #dedede" />
						<span class="rs_mail">${user.email}</span> <span
